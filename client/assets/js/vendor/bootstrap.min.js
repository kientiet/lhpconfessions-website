...
if ("undefined" === typeof jQuery) {
    ...
    "use strict"; function b(b) {
        ...
        var c = this.getItemIndex(b), d = "prev" == a && 0 === c || "next" == a && c == this.$items.length - 1; if (d && !this.options.wrap) {
            return b;
        } var e = "prev" == a ? -1 : 1, f = (c + e) % this.$items.length; return this.$items.eq(f);
    ...
    "use strict"; function b(b) {
        ...
        } var h = null == this.affixed, i = h ? e : f.top, j = h ? g : b; return null != c && c >= e ? "top" : null != d && i + j >= a - d ? "bottom" : !1;
